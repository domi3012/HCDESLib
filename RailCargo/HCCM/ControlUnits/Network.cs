...
namespace RailCargo.HCCM.ControlUnits
{
    public class Network : ControlUnit
    {
        ...
        protected override void CustomInitialize(DateTime startTime, ISimulationEngine simEngine)
        {
            ...
            {
                Train scheduledTrain = new Train(train.Item1, train.Item2,
                    train.Item3, train.Item4);
                TrainCreation trainCreation = new TrainCreation(this, scheduledTrain);
                //TODO change to depatureTime - placeholder
                simEngine.AddScheduledEvent(trainCreation, DateTime.Now);
            }
        }
