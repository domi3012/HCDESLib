...
{
    public class RoutingPath : ControlUnit
    {
        private readonly object _inputPaths;

        public RoutingPath(string name, ControlUnit parentControlUnit, SimulationModel parentSimulationModel, InputPath inputPath) : base(
